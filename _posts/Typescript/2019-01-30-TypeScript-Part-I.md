...
- Template string: Span multiple lines and have embedded expressions.
...
- **Tuple:** 
    ...
    - ALSO: Accessing an element outside the set of known indices fails with an error.
...
- **Enums:**
    - ADDITION from standard datatypes in JavaScript.
